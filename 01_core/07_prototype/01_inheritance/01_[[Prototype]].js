/*
    [[Prototype]]
    자바스크립트에서 객체는 [[Prototype]] 이라는 숨겨진 프로퍼티를 가지고있다.
    이것은 null 이거나, 다른 객체에 대한 참조를 가지고있다.
*/
...
/*
    __proto__   (java의 extends(상속) 역할)
    [[Prototype]] 의 getter 와 setter 의 역할을 한다.
*/

// student 과 user 를 연결하겠다.
student.__proto__ = user;

console.log(student.id);

// student 의 프로토타입은 user 로 설정을 했다.
// 이 말은 student 는 user 를 상속 받았다고 생각하면 된다.
